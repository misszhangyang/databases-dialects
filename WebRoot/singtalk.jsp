...
<body class="body_one">
	<div class="overall">
		...
		<div class="context-centertop">
			<a class="shouye" href="index.jsp">首页</a>>><a href="singtalk.jsp">说唱视频</a>
		</div>
		<div class="context-center">
			<video class="video" width="600" height="300" controls>
				<source src="video/hzsingtalk.mp4" type="video/mp4">
