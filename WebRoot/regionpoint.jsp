...
<body class="body_one">
	<div class="overall">
		<div class="head">
			<span
				style="font-size:40px;font-family:楷体;font-weight:500;padding-left:30px;padding-right:120px"><a href="index.jsp"><img src="img/icon.jpg" width="130" height="65" /></a>徽州方言数据库</span><img
				src="img/head.png" width="41" height="27" /><a>重要公告</a> <span>|</span>
			<a>与我联系</a> <span>|</span> <a>加入收藏</a>
			<p>
				<a href="index.jsp" style="margin-left:50px;font-size:16px;">网站首页</a> <a
		        href="overview" style="margin-left:50px;font-size:16px;text-decoration:none">方言概述</a> <a
				href="voicevideo"	style="margin-left:50px;font-size:16px;text-decoration:none">语音视屏</a> <a
			 
			 	href="singtalk.jsp"	style="margin-left:50px;font-size:16px;text-decoration:none">说唱视屏</a> <a
				href="regionpoint.jsp"	style="margin-left:50px;font-size:16px;text-decoration:none">区域特点</a> <a
				href="overview.jsp"	style="margin-left:50px;font-size:16px;text-decoration:none">地区分布</a> <a
				href="overview.jsp"	style="margin-left:50px;font-size:16px;text-decoration:none">给我留言</a>
			</p>
		</div>
		...
		<div class="context-centertop">
			<a class="shouye" href="index.jsp">首页</a>>><a href="regionpoint.jsp">区域特点</a>
		</div>
		<div class="context-center">
			<video class="video" width="500" height="300" controls>
				<source src="video/hsmp4.mp4" type="video/mp4">
				<source src="" type="video/ogg"> <source src=""
